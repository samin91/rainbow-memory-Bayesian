...
class ResNetBase(nn.Module):
    ...
    def __init__(self, opt, block, layers, zero_init_residual=False,
        ...
        # Experimenting with avgpool instead of maxpool2d
        ...
        #this layer may contain batch norm and relu! -but why?
        # remove batchnorm and relu from the final layer
        #self.fc = FinalBlock(opt=opt, in_channels=512 * block.expansion)
        self.fc=nn.Linear(512 * block.expansion, opt.num_classes, bias=False)
